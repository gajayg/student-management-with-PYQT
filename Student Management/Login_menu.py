...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(356, 380)
        self.formLayoutWidget = QtWidgets.QWidget(Dialog)
        self.formLayoutWidget.setGeometry(QtCore.QRect(80, 90, 205, 169))
        ...
        self.label_4.setGeometry(QtCore.QRect(140, 50, 91, 20))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "Login Menu"))
